...
fRsizeImages(DIR_DATASET_TRAIN_NORMAL,DIR_DATASET_TRAIN_NORMAL_RSIZED,64,64)
fRsizeImages(DIR_DATASET_TRAIN_PNEUMONIA,DIR_DATASET_TRAIN_PNEUMONIA_RSIZED,64,64)


fRsizeImages(DIR_DATASET_TEST_NORMAL,DIR_DATASET_TEST_NORMAL_RSIZED,64,64)
fRsizeImages(DIR_DATASET_TEST_PNEUMONIA,DIR_DATASET_TEST_PNEUMONIA_RSIZED,64,64)


fRsizeImages(DIR_DATASET_VAL_NORMAL,DIR_DATASET_VAL_NORMAL_RSIZED,64,64)
fRsizeImages(DIR_DATASET_VAL_PNEUMONIA,DIR_DATASET_VAL_PNEUMONIA_RSIZED,64,64)
